...
/** Host component used to drive the AssigneeSelectComponent under test. */
@Component({
  template: `<app-assignee-select
    [value]="value"
...
describe('AssigneeSelectComponent', () => {
  ...
  /**
   * Test environment for AssigneeSelectComponent tests.
  ...
  class TestEnvironment {
    ...
    readonly component: AssigneeSelectComponent;
    ...
    constructor({
      ...
      this.component = this.fixture.debugElement.children[0].componentInstance as AssigneeSelectComponent;
